...
const LOCAL_DELETE_KEYS = [
  ...
  STORAGE_KEYS.STUDY_PROJECTS,
  STORAGE_KEYS.STUDY_UNITS,
  STORAGE_KEYS.STUDY_PLANS,
  STORAGE_KEYS.STUDY_SESSIONS,
  STORAGE_KEYS.STUDY_REPETITION,
  STORAGE_KEYS.STUDY_PROGRESS_STEPS,
  STORAGE_KEYS.STUDY_USAGE,
  STORAGE_KEYS.BILLING_STATUS,
